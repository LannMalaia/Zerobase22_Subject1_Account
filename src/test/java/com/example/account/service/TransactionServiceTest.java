...
class TransactionServiceTest {
	...
	public static final long CANCEL_AMOUNT = 3000L;
    ...
    void successUseBalance_UserNotFound() {
    	// given
    	given(accountUserRepository.findById(anyLong()))
    ...
    void successUseBalance_AccountNotFound() {
    	// given
    	AccountUser user = AccountUser.builder()
				.id(12L)
				.name("Pobi").build();
    ...
    void successUseBalance_userUnMatch() {
    	// given
    ...
    @Test
    @DisplayName("이미 해지된 계좌에서 사용하려 함")
    void successUseBalance_alreayUnregistered() {
    	// given
    	AccountUser pobi = AccountUser.builder()
				.id(12L)
				.name("Pobi").build();
    ...
    @Test
    @DisplayName("거래 금액이 잔고보다 많음")
    void successUseBalance_exceed() {
    	// given
    	AccountUser user = AccountUser.builder()
				.id(12L)
				.name("Pobi").build();
    ...
    @Test
    @DisplayName("취소는 1년전 것 까지만 - 잔액 사용 취소 실패")
